...
class NotificationsViewController: UIViewController, NotificationsView {
    ...
    override func viewDidLoad() {
        ...
        presenter = NotificationsPresenter(section: section, notificationsAPI: ApiDataDownloader.notifications, usersAPI: ApiDataDownloader.users, notificationStatusesAPI: NotificationStatusesAPI(), view: self)
