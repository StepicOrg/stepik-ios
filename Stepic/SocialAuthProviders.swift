...
enum SocialProvider: Int {
    ...
    var info: SocialProviderInfo {
        switch self {
        case .vk:
            return SocialProviderInfo(name: self.name, image: #imageLiteral(resourceName: "vk"),
        ...
        case .google:
            return SocialProviderInfo(name: self.name, image: #imageLiteral(resourceName: "google"),
        ...
        case .facebook:
            return SocialProviderInfo(name: self.name, image: #imageLiteral(resourceName: "fb"),
        ...
        case .twitter:
            return SocialProviderInfo(name: self.name, image: #imageLiteral(resourceName: "twitter"),
        ...
        case .gitHub:
            return SocialProviderInfo(name: self.name, image: #imageLiteral(resourceName: "github"),
        ...
        case .itMailRu:
            return SocialProviderInfo(name: self.name, image: #imageLiteral(resourceName: "mail"),
