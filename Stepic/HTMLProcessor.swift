...
class HTMLProcessor {
    ...
    func process(htmlString: String, textColor: UIColor = UIColor.mainText) -> String {
        var res = "<html>\n"
        var head = ""
        var body = htmlString

        head += "\(Scripts.metaViewport)\(Scripts.localTexScript)\(Scripts.clickableImagesScript)"
