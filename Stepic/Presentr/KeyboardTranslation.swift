...
extension Notification {
    ...
    func keyboardEndFrame () -> CGRect? {
        return ((self as? NSNotification)?.userInfo?[UIKeyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue
    }
    ...
    func keyboardAnimationDuration () -> Double? {
        return ((self as? NSNotification)?.userInfo?[UIKeyboardAnimationDurationUserInfoKey] as? NSNumber)?.doubleValue
    }
}
