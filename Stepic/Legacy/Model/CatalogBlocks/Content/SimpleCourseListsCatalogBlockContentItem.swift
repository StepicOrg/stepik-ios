...
final class SimpleCourseListsCatalogBlockContentItem: CatalogBlockContentItem {
    ...
    override var description: String {
        """
        SimpleCourseListsCatalogBlockContentItem(id: \(self.id), \
        title: \(self.title), \
    ...
    override func isEqual(_ object: Any?) -> Bool {
        guard let object = object as? SimpleCourseListsCatalogBlockContentItem else {
            return false
        }
