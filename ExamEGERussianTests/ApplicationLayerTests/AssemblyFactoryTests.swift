...
class AssemblyFactoryTests: XCTestCase {
    ...
    func testMockAssemblyFactoryTypes() {
        ...
        XCTAssert(mockAssemblyFactory.learningAssembly is LearningAssemblyMock)
        XCTAssert(mockAssemblyFactory.trainingAssembly is TrainingAssemblyMock)
    ...
    func testConcreateAssemblyFactoryTypes() {
        ...
        XCTAssert(concreateAssemblyFactory.learningAssembly is LearningAssembly)
        XCTAssert(concreateAssemblyFactory.trainingAssembly is TrainingAssembly)
