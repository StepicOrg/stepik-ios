...
struct StepicApplicationsInfo {
    ...
    struct RateApp {
        static let correctSubmissionsThreshold = 20
        static let appStoreURL = URL(string: "itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=1239082208&onlyLatestVersion=true&pageNumber=0&sortOrdering=1&type=Purple+Software&action=write-review")
    }
